...
G           = EasyDict(func='networks.G_paper_thin_shallow')             # Options for generator network.
D           = EasyDict(func='networks.D_paper_thin_shallow')             # Options for discriminator network.
